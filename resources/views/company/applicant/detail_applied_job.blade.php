            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{action('ApplicantController@acceptInterview', $vacancies->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        @if ($applyings->status == 'Interview schedule sent' || $applyings->status == 'Interview on progress'|| $applyings->status == 'Rejected'|| $applyings->status == 'Accepted')
                            <div class="row mb-2">
                                <div class="card-body">
                                    <div class="card-mb-3" style="width: 50%">
                                        <div class="form-group">
                                    ...
                                    <div class="timeline-steps aos-init aos-animate" data-aos="fade-up">
                                        ...
                                        <div class="timeline-step">
                                            <div class="timeline-content" data-toggle="popover" data-trigger="hover" data-placement="top" title="" >
                                                <div class="process-circle"></div>
                                                {{-- <p class="h6 mt-3 mb-1">2005</p> --}}
                                                @if($applyings->status == 'Interview schedule sent')
                                                    <p class="h6 text-muted mb-0 mb-lg-0">Interview Scheduled</p>
                                                @endif
                                                @if($applyings->status == 'Interview on progress')
                                                    <p class="h6 text-muted mb-0 mb-lg-0">Interview on progress</p>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="timeline-step">
                                    ...
                                    <div class="timeline-steps aos-init aos-animate" data-aos="fade-up">
                                        ...
                                        <div class="timeline-step">
                                            <div class="timeline-content" data-toggle="popover" data-trigger="hover" data-placement="top" title="">
                                                ...
                                                {{-- <p class="h6 mt-3 mb-1">2004</p> --}}
                                                <p class="h6 text-muted mb-0 mb-lg-0">Rejected</p>
                                            </div>
                                        </div>
                                        <div class="timeline-step">
                                            <div class="timeline-content" data-toggle="popover" data-trigger="hover" data-placement="top" title="" >
