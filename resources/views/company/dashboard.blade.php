                            ...
                            <tbody>
                                ...
                                @foreach ($vacancies as $item)
                                    <tr>
                                        ...
                                        <td class = "align-middle" width ="30%" scope="row"><a style="text-decoration-line: none ; color:#212529;" href="/vacancy/{{$item->id}}">{{$item->job_name}}</a></td>
                                        ...
                                        <td class = "align-middle" width ="25%" style="text-align: center" scope="row" >
