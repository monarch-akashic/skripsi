                                ...
                                <div class="card-mb-3" style="width: 50%">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="job_requirement" id="article-ckeditor" rows="3"
                                ...
                                <div class="card-mb-3" style="width: 50%">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row ml-1">
                                                <input type="text" name="total_applicant" class="form-control mr-3"
                                                    placeholder=""
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row ml-1">
                                                <input type="text" name="working_hour_range_1" class="form-control mr-3"
                                                    placeholder=""
                                                    value="{{ old('working_hour_range_1') }}"
                                                    style="width:15%;">-
                                                <input type="text" name="working_hour_range_2" class="form-control ml-3"
                                                    placeholder=""
